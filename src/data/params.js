export const PARAMS = [
  ...
  { id: 'Td',  label: 'Td – czas docisku',        x: 16.4,  y: 85.0, min: 0,   max: 30,   step: 0.5,  unit: 's',   def: 5   },
  { id: 'Pd',  label: 'Pd – ciśn. docisku',       x: 23.1, y: 85.0, min: 0,   max: 220,  step: 5,    unit: 'bar', def: 40  },
  { id: 'Pp',  label: 'Pp – pkt przełączenia',    x: 26.8, y: 78.0, min: 0,   max: 25,   step: 0.5,  unit: 'mm',  def: 10  },
