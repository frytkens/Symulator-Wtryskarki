// Geometria i zakresy parametrów – wspólne dla wszystkich wad.
// "active"/"weight" NIE są tu już trzymane – to zależy od wybranej wady (patrz DEFECTS niżej).

export const PARAMS = [
  { id: 'T1',  label: 'T1 – dysza',              x: 8.9,  y: 12.0, min: 0,   max: 350,  step: 5,    unit: '°C',  def: 220 },
  ...
  { id: 'Pw5', label: 'Pw5',                       x: 28.7, y: 85.0, min: 0,   max: 200,  step: 2,    unit: 'mm/s', def: 80  },
  { id: 'Pw4', label: 'Pw4',                       x: 35.5, y: 85.0, min: 0,   max: 200,  step: 2,    unit: 'mm/s', def: 80  },
  { id: 'Pw3', label: 'Pw3',                       x: 42.4, y: 85.0, min: 0,   max: 200,  step: 2,    unit: 'mm/s', def: 80  },
  { id: 'Pw2', label: 'Pw2',                       x: 49.2, y: 85.0, min: 0,   max: 200,  step: 2,    unit: 'mm/s', def: 80  },
  { id: 'Pw1', label: 'Pw1',                       x: 56.0, y: 85.0, min: 0,   max: 200,  step: 2,    unit: 'mm/s', def: 80  },
  { id: 'GR',  label: 'GR – gr. ciśn. docisku',   x: 62.9, y: 85.0, min: 0,   max: 220,  step: 5,    unit: 'bar', def: 120 },

  { id: 'Deko', label: 'Deko – dekompresja',      x: 74.7, y: 85.0, min: 0,   max: 100,  step: 1,    unit: 'mm',  def: 7   },
